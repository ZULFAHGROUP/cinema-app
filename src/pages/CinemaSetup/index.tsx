...
//                         <p className="text-sm font-serif text-center">SEATS</p>
//                       </div>
//                     </div>
...
function CinemaSetup() {
  ...
  const getButtonConfig = (tab: any) => {
    switch (tab) {
      case "theaters":
        return { text: "Add Theater", icon: <Building2 className="w-4 h-4" /> };
      case "screens":
        return { text: "Add Screen", icon: <Monitor className="w-4 h-4" /> };
      case "seating":
        return { text: "Edit Layout", icon: <Armchair className="w-4 h-4" /> };
      default:
        return { text: "Add", icon: <Plus className="w-4 h-4" /> };
    }
  };
    ...
    <div className="p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <Button
          ...
          onClick={() => console.log(`${activeTab} button clicked`)}
        >
          {buttonConfig.icon}
          {buttonConfig.text}
        </Button>
